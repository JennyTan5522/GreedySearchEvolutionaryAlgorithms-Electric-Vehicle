...
class EVRP:
    ...
    def euclidean_distance(self,cust1:int,cust2:int): 
        '''Compute and return the euclidean distance of 2 coordinates'''
        coor1=(self.NODE[cust1][0],self.NODE[cust1][1]) #(x,y)
        coor2=(self.NODE[cust2][0],self.NODE[cust2][1])
        return distance.euclidean(coor1,coor2)
    
    def compute_distances(self,matrix,ACTUAL_PROBLEM_SIZE):

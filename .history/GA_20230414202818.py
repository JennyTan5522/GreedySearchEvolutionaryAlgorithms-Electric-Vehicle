...
class GA:
    ...
    def mutation_hsm():
        ...
        print('Random customer: ',ci)
        print('Nearest to ci  : ',cj)
        print(finalCluster)
        return finalCluster
    ...
    def newGeneration(self):
        ...
        self.EVRP.read_problems(filenames[0])
